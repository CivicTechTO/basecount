# With thanks to https://itnext.io/how-to-use-webpacker-with-npm-instead-of-yarn-a8a764e3a8ab
...
namespace :webpacker do
  task :check_npm do
    begin
      ...
      package_json_path = Pathname.new("#{__dir__}/../../package.json").realpath
      npm_requirement = JSON.parse(package_json_path.read)['engines']['npm']
